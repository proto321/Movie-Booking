            ...
            <div className={movieDetailStyles.wrapper}>
                ...
                <div className={movieDetailStyles.titleContainer}>
                    ...
                    <div className={movieDetailStyles.movieMeta}>
                        ...
                        <span className={movieDetailStyles.metaItem}>
                            <Star
                                className={`${movieDetailStyles.metaIcon} ${movieDetailStyles.durationIcon}`}
                            />
                            {movie.duration}
                        </span>
                                ...
                                {showtimeDays.map((day, index) => {
                                    return (
                                        <button
                                            ...
                                            className={`${movieDetailStyles.dayButton.base} ${selectedDay === index
                                ...
                                {showtimeDays[selectedDay]?.showtimes.map((showtime, index) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`${movieDetailStyles.timeButton.base} ${selectedTime === showtime.datetime
