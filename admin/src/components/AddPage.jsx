...
import { Clock, Film, ImageIcon, Play, Plus, Star, Upload, Users, X } from 'lucide-react'
...
const AddPage = () => {
    ...
    // const availableCategories = ["Action", "Horror", "Comedy", "Adventure", "Animation"];
    ...
    // file helpers that render the image upload by user  
    ...
    }; // remove image if picked or selected wrong
    ...
    // this function validates all the fields are filled or not with correct details. 
    function validate() {
                        ...
                        {typeof it.name !== "undefined" && (
                            <div className="mt-2">
                                <input
                                    ...
                                    onChange={(e) =>
                                        updateMeta &&
                                        updateMeta(idx, "name", e.target.value)
                                    }
                                    placeholder="Name"
                        ...
                        {typeof it.role !== "undefined" && (
                            <div className="mt-2">
                                <input
                                    ...
                                    onChange={(e) =>
                                        updateMeta &&
                                        updateMeta(idx, "role", e.target.value)
                                    }
                                    placeholder="Role"
                                    className={addMoviePageStyles.uploaderItemInput}
                                />
...
// for latestTrailer we NameUploader 
