...
import { Calendar, Clock, Film, Play, Play as PlayIcon, Search, Star, Ticket, X } from 'lucide-react';
...
const ListMoviesPage = () => {
    ...
    // it will fetch the movie details 
                ...
                <div className={styles5.detailEmptyState}>
                  <div className="flex items-center justify-center mb-3 w-full">
                    <div className={styles5.detailEmptyIcon}>
                      <Film size={60} className="text-blue-600" />
                    </div>
                  </div>
...
function Card({ item, onOpen, onDelete }) {
  const getTypeColor = (type) => {
    const colors = {
      featured: "from-orange-500 to-blue-600",
