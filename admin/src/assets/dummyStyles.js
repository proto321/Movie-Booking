...
export const addMoviePageStyles = {
  ...
  mainContainer: "max-w-6xl mx-auto bg-gradient-to-r from-black via-blue-900 to-black/80 border-2 border-blue-700 rounded-2xl p-4 sm:p-6 md:p-8 shadow-2xl",
  ...
  radioInput: "accent-blue-600",
  
  // Sections
  section: "bg-black/20 p-4 rounded-lg border border-blue-700",
  ...
  input: "w-full rounded-lg p-3 bg-black/20 border border-blue-600 placeholder-gray-400",
  textarea: "w-full rounded-lg p-3 bg-black/20 border border-blue-600",
  numberInput: "w-32 rounded-lg p-2 bg-black/20 border border-blue-600",
  select: "w-full rounded-lg p-2 bg-black/20 border border-blue-600",
  
  // Category buttons
  categoryContainer: "flex gap-3 flex-wrap",
  categoryButton: "px-3 py-1 rounded-full border",
  categoryButtonSelected: "bg-blue-700 text-white border-blue-700",
  categoryButtonNormal: "bg-black/20 border-gray-700",
  
  // File upload areas
  uploadContainer: "border-2 border-dashed border-blue-700 rounded-lg p-3 bg-black/30",
  uploadContent: "flex flex-col items-center justify-center gap-2 cursor-pointer",
  uploadIconContainer: "p-4 rounded-md bg-black/40 border border-blue-700",
  uploadIcon: "size-36",
  ...
  removeButton: "absolute -top-2 right-2 bg-blue-700/90 p-1 rounded-full",
  removeIcon: "size-6",
  ...
  durationInput: "w-32 rounded-lg p-2 bg-black/20 border border-blue-600",
  
  // Slots section
  slotsHeader: "flex items-center justify-between mb-3",
  addSlotButton: "flex items-center gap-2 px-3 py-1 rounded-full bg-blue-700 text-sm",
  addSlotIcon: "",
  ...
  slotRemoveButton: "p-2 rounded-full bg-blue-700",
  
  // Uploader components
  uploaderContainer: "p-3 bg-black/20 rounded-lg border border-blue-700",
  ...
  uploaderAddButton: "text-xs px-3 py-1 bg-blue-700 rounded-full cursor-pointer",
  ...
  uploaderItemRemove: "absolute -top-1 -right-2 bg-blue-700 p-1 rounded-full",
  ...
  resetButton: "px-4 py-2 rounded-lg border border-blue-700 w-full sm:w-auto",
  submitButton: "px-6 py-2 rounded-lg bg-blue-700 font-semibold w-full sm:w-auto",
...
export const styles2 = {
  ...
  // Form elements
  select: "px-3 py-2 rounded-lg bg-gray-900 border border-blue-800 text-sm outline-none focus:ring-2 focus:ring-blue-600",
  clearButton: "px-3 py-2 rounded-lg bg-blue-700 text-white text-sm hover:brightness-95",
  
  // Grid and cards
  gridContainer: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4",
  messageContainer: "col-span-full text-center text-gray-400 py-8 border border-blue-800 rounded-lg",
  bookingCard: "bg-gradient-to-r from-gray-900 to-black border border-blue-800 rounded-xl p-4 shadow-lg flex flex-col justify-between",
  
  // Card content
  movieIconContainer: "w-12 h-12 rounded-md bg-blue-800 flex items-center justify-center text-white",
  movieTitle: "text-lg font-bold text-blue-300",
...
export const styles3 = {
  ...
  dashboardTitle: "text-2xl sm:text-3xl md:text-4xl font-extrabold text-blue-500",
  ...
  summaryCard: "rounded-2xl border border-blue-800 bg-gradient-to-b from-gray-900/60 to-black p-4 shadow-lg",
  summaryCardInner: "flex items-center justify-between",
  summaryLabel: "text-xs text-gray-400",
  summaryValue: "text-2xl sm:text-3xl font-bold text-blue-400",
  summaryBadge: "px-3 py-2 rounded-lg bg-blue-800/20 text-blue-300 text-sm font-medium",
  summaryNote: "mt-3 text-xs text-gray-500",
  
  // Movies section
  moviesSection: "rounded-2xl border border-blue-800 bg-gradient-to-b from-gray-900 to-black p-4 shadow-inner",
  moviesHeader: "flex items-center justify-between mb-4",
  moviesTitle: "text-lg font-semibold text-blue-400",
  moviesCount: "text-sm text-gray-400",
  
  // Table styles
  tableContainer: "hidden lg:block overflow-x-auto",
  table: "w-full table-auto",
  tableHeader: "text-xs text-gray-400 text-left border-b border-blue-900/30",
  tableHeaderCell: "py-2 px-3",
  tableRow: "border-b border-blue-900/20 hover:bg-white/2 transition-colors",
  tableMovieTitle: "font-semibold text-white",
  tableCell: "py-3 px-3 text-sm text-gray-200",
  tableEarnings: "py-3 px-3 text-sm text-blue-300 font-semibold",
  tableAvg: "py-3 px-3 text-sm text-gray-300",
  tableEmpty: "py-6 text-center text-gray-500",
  
  // Mobile cards
  mobileList: "lg:hidden space-y-3",
  mobileCard: "bg-gradient-to-b from-gray-900/70 to-black border border-blue-800 rounded-xl p-4 shadow-sm",
  ...
  mobileEarnings: "text-sm text-blue-300 font-semibold",
...
export const styles4 = {
  ...
  // Navbar styles
  navbar: "bg-black border-b-2 border-blue-600 shadow-2xl relative z-40",
  ...
  logoIcon: "flex items-center justify-center w-10 h-10 bg-blue-600 rounded-full transform rotate-12 hover:rotate-0 transition-transform duration-300",
  logoIconInner: "w-6 h-6 text-white transform -rotate-12",
  logoText: "font-['Impact'] text-2xl text-white tracking-wider bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text",
  desktopNav: "hidden lg:flex lg:space-x-4",
  mobileMenuButton: "inline-flex items-center justify-center p-2 rounded-md text-blue-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600",
  mobileMenuIcon: "w-6 h-6",
  
  // Navigation links
  navLinkBase: "group flex items-center space-x-2 px-4 py-2 rounded-full border border-blue-800 transition-all duration-300 transform",
  navLinkActive: "bg-blue-700 hover:from-blue-800 scale-105 shadow-lg shadow-blue-900/50",
  navLinkInactive: "bg-gradient-to-r from-blue-900 to-black hover:from-blue-800 hover:to-black",
  navLinkIconBase: "w-5 h-5 transition-colors",
  navLinkIconActive: "text-white",
  navLinkIconInactive: "text-blue-400 group-hover:text-blue-300",
  navLinkTextBase: "font-['Arial_Black'] text-sm tracking-wide transition-colors",
  navLinkTextActive: "text-white",
  navLinkTextInactive: "text-white group-hover:text-blue-200",
  ...
  mobileMenuPanel: "fixed top-0 right-0 h-full w-72 max-w-full bg-gradient-to-b from-black/95 to-black/90 border-l border-blue-800 shadow-2xl transform transition-transform duration-300 lg:hidden",
  mobileMenuPanelHeader: "flex items-center justify-between px-4 py-4 border-b border-blue-800",
  mobileMenuPanelNav: "px-4 py-6 space-y-3",
  mobileMenuPanelFooter: "absolute bottom-0 left-0 right-0 p-4 border-t border-blue-800",
  mobileMenuFooterText: "text-xs text-blue-300",
  
  // Mobile navigation links
  mobileNavLinkBase: "flex items-center space-x-3 w-full px-4 py-3 rounded-lg transition-colors",
  mobileNavLinkActive: "bg-blue-700 text-white shadow-md",
  mobileNavLinkInactive: "hover:bg-white/5 text-blue-200",
  mobileNavLinkIconBase: "w-5 h-5",
  mobileNavLinkIconActive: "text-white",
  mobileNavLinkIconInactive: "text-blue-300",
...
export const styles5 = {
  ...
  searchInput: "w-full px-12 py-3 rounded-2xl text-sm sm:text-base md:text-lg bg-gray-800/50 border border-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent backdrop-blur-sm",
  ...
  filterButtonActive: "bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg shadow-blue-500/25",
  filterButtonInactive: "gradient-border text-gray-300 hover:bg-blue-900/20 hover:text-white hover:border-blue-500/40",
  ...
  errorContainer: "col-span-full p-6 text-center text-blue-300 rounded-2xl gradient-border",
  errorMessage: "font-semibold",
  errorRetryButton: "px-4 py-2 bg-blue-700 rounded-lg",
  ...
  cardDeleteButton: "absolute top-3 right-3 z-10 p-2 cursor-pointer rounded-full bg-blue-700/90 hover:bg-blue-800 text-white transition-colors",
  ...
  cardTitle: "font-bold text-lg text-white truncate group-hover:text-blue-300 transition-colors mb-1",
  ...
  cardViewButton: "flex items-center gap-2 px-4 md:px-2 md:text-xs py-2 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl text-white text-sm font-semibold hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-blue-500/25 cursor-pointer",
  cardTrailerButton: "flex items-center gap-2 px-3 py-2 gradient-border rounded-xl text-gray-300 text-sm hover:text-white hover:border-blue-500/60 transition-all duration-300 cursor-pointer",
  cardTrailerIcon: "w-4 h-4 text-blue-500",
  ...
  detailLiveDot: "w-2 h-2 bg-blue-500 rounded-full animate-pulse",
  ...
  detailCloseButton: "flex-shrink-0 p-2.5 gradient-border rounded-xl text-gray-400 hover:text-white hover:border-blue-500/60 transition-all duration-300 cursor-pointer",
  ...
  watchTrailerButton: "flex items-center justify-center gap-3 w-full py-4 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl text-white font-bold hover:from-blue-700 hover:to-blue-800 transition-all duration-300 cursor-pointer transform hover:scale-[1.02] shadow-lg",
  ...
  storyDot: "w-1.5 h-6 bg-blue-500 rounded-full",
  storyText: "text-gray-300 leading-relaxed text-base",
  
  // Showtimes
  showtimesSection: "space-y-4",
  showtimesHeader: "flex items-center gap-3",
  showtimesIcon: "text-blue-400",
  showtimesList: "space-y-3",
  showtimeItem: "flex items-center justify-between p-4 gradient-border rounded-2xl hover:border-blue-500/60 transition-all duration-300 cursor-pointer",
  ...
  personDot: "w-1.5 h-6 bg-blue-500 rounded-full",
  ...
  personAvatar: "w-20 h-20 object-cover rounded-2xl mb-3 mx-auto border-2 border-gray-600 group-hover:border-blue-500 transition-all duration-300 group-hover:scale-105",
