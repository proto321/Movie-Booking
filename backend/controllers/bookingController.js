...
// theis fundtion gives you total amt and it also calculate amt for standard and recliner
...
export async function deleteBooking(req, res) {
  try {
    ...
    if (!b) return res.status(400).json({
...
export async function confirmPayment(req, res) {
  try {
    ...
    const sessionObj = await stripe.checkout.sessions.retrieve(sessions_id)
